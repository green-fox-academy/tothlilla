...
void draw()
{
    ...
    SDL_RenderDrawLine(gRenderer, 000, 000, 640, 480);// Draw the canvas' diagonals.
    SDL_SetRenderDrawColor(gRenderer, 0xFF /*R*/, 0x00 /*G*/, 0x00 /*B*/, 0xFF /*A*/);
    SDL_RenderDrawLine(gRenderer, 640, 0, 0, 480);// If it starts from the upper-left corner it should be green, otherwise it should be red.
