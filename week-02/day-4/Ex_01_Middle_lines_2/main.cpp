...
void draw()
{
    ...
    SDL_RenderDrawLine(gRenderer, 200, 240, 440, 240);// draw a red horizontal line to the canvas' middle.
    SDL_SetRenderDrawColor(gRenderer, 0x00 /*R*/, 0xFF /*G*/, 0x00 /*B*/, 0xFF /*A*/);
    SDL_RenderDrawLine(gRenderer, 320, 170, 320, 310);// draw a green vertical line to the canvas' middle.
}
