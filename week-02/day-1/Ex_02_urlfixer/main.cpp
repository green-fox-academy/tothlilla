...
int main(int argc, char *args[]) {
    ...
    int start_replace = url.find(
            need_expression); //Determinding the beginning index of the changing word with x.find function
    ...
    std::string need_char = ":"; //The string of new part
    url.insert(5, need_char, 0, 1); //The method of inserting new parts in a string.
